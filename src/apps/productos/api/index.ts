...
formData.append(`payload`, JSON.stringify(productoApiCrearProductoBody.payload));
...
formData.append(`payload`, JSON.stringify(productoApiActualizarProductoBody.payload));
